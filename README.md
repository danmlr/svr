...
This code implements the theoretical framework developped by D. Meller and N. Berkouk (citation) which allows to investigate the inner structure of neural networks. [Paper link]('https://arxiv.org/abs/2302.08183')
